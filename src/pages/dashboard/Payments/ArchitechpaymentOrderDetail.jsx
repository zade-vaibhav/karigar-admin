...
export function ArchitechPaymentorderDetail() {
            ...
            <Card className="mx-3 -mt-16 mb-6 lg:mx-4 border border-blue-gray-100">
                <CardBody className="p-4">
                    <div className="gird-cols-1 mb-12 grid gap-12 px-4 lg:grid-cols-2 xl:grid-cols-3">
                        ...
                        />
                      <ProfileInfoCard
                            title="Architech Detail"
                            details={{
                                "name": `${Architechorder?.payment?.paymentDetails?.payee?.name}`,
                                "Email": `${Architechorder?.payment?.paymentDetails?.payee?.email}`,
                                "Mobile Number": `${Architechorder?.payment?.paymentDetails?.payee?.mobile_number}`,
                                "Alternet Mobile Number": `${Architechorder?.payment?.paymentDetails?.payee?.alternateNumber}`,
                            }}
                        />
                           <ProfileInfoCard
                            title="Architech bank Detail"
                            details={{
                                "Account holder name": `${Architechorder?.payment?.paymentDetails?.payee?.bankDetails?.accountHolderName}`,
                                "Bank Name": `${Architechorder?.payment?.paymentDetails?.payee?.bankDetails?.bankName}`,
                                "Account Number": `${Architechorder?.payment?.paymentDetails?.payee?.bankDetails?.accountNumber}`,
                                "IFSC code": `${Architechorder?.payment?.paymentDetails?.payee?.bankDetails?.ifscCode}`,
                            }}
                        />
                    </div>
                </CardBody>
...
export default ArchitechPaymentorderDetail;
