...
export function KarigarPaymentorderDetail() {
                    ...
                    <div className="gird-cols-1 mb-12 grid gap-12 px-4 lg:grid-cols-2 xl:grid-cols-3">
                        ...
                        />
                         <ProfileInfoCard
                            ...
                            details={{
                                "name": `${workerOrder?.payment?.paymentDetails?.payee?.name}`,
                                "Designation": `${workerOrder?.payment?.paymentDetails?.payee?.designation}`,
                                "Address": `${workerOrder?.address}`,
                                "Mobile Number": `${workerOrder?.payment?.paymentDetails?.payee?.mobile_number}`,
                            }}
                        />

                        <ProfileInfoCard
                            title="Karigar bank Detail"
                            details={{
                                "Account holder name": `${workerOrder?.payment?.paymentDetails?.payee?.bankDetails?.accountHolderName}`,
                                "Bank Name": `${workerOrder?.payment?.paymentDetails?.payee?.bankDetails?.bankName}`,
                                "Account Number": `${workerOrder?.payment?.paymentDetails?.payee?.bankDetails?.accountNumber}`,
                                "IFSC code": `${workerOrder?.payment?.paymentDetails?.payee?.bankDetails?.ifscCode}`,
                            }}
                        />
                    </div>
                </CardBody>
...
export default KarigarPaymentorderDetail;
