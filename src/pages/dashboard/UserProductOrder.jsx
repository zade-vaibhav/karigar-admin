                    ...
                    <div className="gird-cols-1 mb-12 grid gap-12 px-4 lg:grid-cols-2 xl:grid-cols-3">
                        ...
                        <ProfileInfoCard
                            ...
                            details={{
                                ...
                                "Price": `${userOrder?.payment?.paymentDetails
.price}`,
                                "Total Price": `${userOrder?.payment?.paymentDetails?.finalPrice} Rs`,
                                "Shipping Address": `${userOrder?.deleveryAddress?.addressLine || null}, ${userOrder?.deleveryAddress?.city || null}, ${userOrder?.deleveryAddress?.state || null}, ${userOrder?.deleveryAddress?.pincode || null}`,
                        ...
                        <ProfileInfoCard
                            ...
                            details={{
                                ...
                                "Payment Date": `${userOrder?.payment?.createdAt.slice(0, 10)}, ${userOrder?.payment?.createdAt.slice(11, 19)}`,
                            }}
                        />
                    </div>
                </CardBody>
